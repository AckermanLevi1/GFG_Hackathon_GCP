...
const WhatWeOffer = () => {
  ...
  <div class="container px-5 py-24 mx-auto" style={{background:"none",boxShadow:"none"}}>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 md:w-1/3">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src={img1} alt="blog"/>
          <div class="p-6 bg-white">
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Marketplace</h1>
            <p class="leading-relaxed mb-3">We offer fresh vegetables from farms all over india</p>
...
<section class="text-gray-600 body-font mobile-visible">
  <div class="container px-5 py-24 mx-auto" style={{background:"none",boxShadow:"none"}}>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 md:w-1/3">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src={img2} alt="blog"/>
          <div class="p-6 bg-white">
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Rental Services</h1>
            <p class="leading-relaxed mb-3">You can opt for various farm related services</p>
            <div class="flex items-center flex-wrap justify-center">
              <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 ">Learn More
                <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
...
<section class="text-gray-600 body-font mobile-visible">
  <div class="container px-5 py-24 mx-auto" style={{background:"none",boxShadow:"none"}}>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 md:w-1/3">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src={img3} alt="blog"/>
          <div class="p-6 bg-white">
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Farming Advisor</h1>
            <p class="leading-relaxed mb-3">You can use our multiple ML models to predict farming related stuffs</p>
            <div class="flex items-center flex-wrap justify-center">
              <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0 ">Learn More
                <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
